...
public class VioletDTO {
	...
	public VioletDTO(String name, String color, String numberOfLeaves, String bloom, String plantLength) {
		super();
		this.name = name;
		this.color = color;
	...
	public String toString() {
		return "VioletDTO [name=" + name + ", color=" + color + ", numberOfLeaves=" + numberOfLeaves + ", bloom="
