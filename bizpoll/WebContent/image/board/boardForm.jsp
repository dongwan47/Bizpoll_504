...
<form action="boardAdd.bizpoll" name="articleForm" method="post" enctype="bultipart/form-data"> 
	...
	<table border="0" align="center">
		...
		<tr>
			...
			<td colspan="2"><textarea name="context" rows="10" cols="65" maxlength="4000"></textarea></td>		
		</tr>
		<tr>
			...
			<td><img id="preview" alt="preview" src="#"></td>
		</tr>
		<tr>
			<td align="right"></td>
			<td colspan="2">
