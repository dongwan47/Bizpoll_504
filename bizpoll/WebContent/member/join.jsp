...
<<script type="text/javascript">
	$(document).ready(function() {
		$("#idChk").blur(function() {
			...
			if (id == "") {
				$("#idChk").val("필수입력항목 입니다.").css("background-color", "red");
			} else {
				$("#idChk").css("background-color", "white");
				$.ajax({ 
					type : "POST",
					url : "id_check_from.bizpoll",
					dataType : "json",
					data : "id=" + id,
...
<article>
	...
	<form action="join.bizpoll" id="join" method="post" name="frm">
		<fieldset>
			...
			<input type="password" pwdCheck><br>
			<label>Name</label>
		...
		<div id="buttons">
			<input type="button" value="회원가입" class="submit" onclick="go_save();"><br>
